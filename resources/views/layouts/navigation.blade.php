        ...
        <ul>
            ...
            @if (!Auth::guest())
                <li x-data="{open: false}" class="relative">
                    <a
                        @click="open = !open"
                        class="cursor-pointer flex justify-between items-center py-2 px-3 hover:bg-gray-200"
                    >
                    ...
                    >
                        ...
                        <li class="hover:bg-slate-900">
                            <a
                                ...
                                class="flex items-center px-3 py-2 hover:bg-gray-200"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 mr-2"
            ...
            @else
                <li>
                    <a
                        href="{{ route('login') }}"
                        class="flex items-center py-2 px-3 transition-colors hover:bg-gray-100 ml-3"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-6 w-6 mr-2"
        ...
        <ul class="grid grid-flow-col items-center">
            ...
            @if (!Auth::guest())
                <li x-data="{open: false}" class="relative">
                    <a
                        @click="open = !open"
                        class="cursor-pointer flex items-center py-navbar-item px-navbar-item pr-5 hover:bg-gray-200"
                    >
              <span class="flex items-center">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                My Account
                    ...
                    <ul
                        ...
                        x-transition
                        x-cloak
                        class="absolute z-10 right-0 bg-gray-100 py-2 w-48"
                    >
                        <li>
                            <a
                                href="{{ route('profile') }}"
            ...
            @else
                <li>
                    <a
                        href="{{ route('login') }}"
                        class="flex items-center py-navbar-item px-navbar-item hover:bg-gray-200"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 mr-2"
